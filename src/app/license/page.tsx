  ...
  return (
    <AppShell>
      <div className="rounded-2xl bg-white p-6 shadow-sm dark:bg-zinc-950 dark:ring-1 dark:ring-white/10">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">License / Read Me</h1>

        <div className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
          Ownership, copyright, and internal-use wording for the Umber Canada operating system.
        </div>
